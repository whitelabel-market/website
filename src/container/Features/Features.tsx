        ...
        <div className="grid items-center lg:grid-cols-2 items-center">
          ...
          <div className="w-full max-w-xl mx-auto p-8 space-y-8 lg:order-first">
            <div className={`space-y-4`}>
              <span className="block font-serif text-xs lg:text-7xl slashed-zero">
                01
              </span>
              <h3 className="subtitle">
                Strategic support for blockchain ecosystems
              </h3>
              <h2 className="title-2 font-serif">
      ...
      <section className={`lg:!pt-0`}>
        <div className="grid items-center lg:grid-cols-2 items-center">
          ...
          <div className="w-full max-w-xl mx-auto p-8 space-y-8">
            <div className={`space-y-4`}>
              <span className="block font-serif text-6xl lg:text-7xl slashed-zero">
                02
              </span>
              <h3 className="subtitle">Incubation of our projects</h3>
              <h2 className="title-2 font-serif">
            ...
            <p>
              ...
              provides the resources to build a successful product. Our goal is
              to deliver maximum value to users while solidifying the business
              model. In this way, we produce companies that are both profitable
              and impactful, driving blockchain towards mainstream use.
            </p>
